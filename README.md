...
<ul>
	<li>1568 / 1568 test cases passed.</li>
	<li>Runtime: 36 ms <code>runtime beats 89.84 % of cpp submissions.</code></li>
	<li>Memory Usage: 71.4 MB <code>memory usage beats 50.27 % of cpp submissions.</code></li>
</ul>
<br>
<br>
The challenge is as follows (https://leetcode.com/problems/add-two-numbers/):
<br>
<br>
